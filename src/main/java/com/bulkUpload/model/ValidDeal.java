...
public class ValidDeal  implements java.io.Serializable {
	 ...
	 * @param fileName
	 */
	public ValidDeal(Integer id, String fromCurrency, String toCurrency, Date dealDate, BigInteger amount,
			String fileName) {
		super();
		this.id = id;
